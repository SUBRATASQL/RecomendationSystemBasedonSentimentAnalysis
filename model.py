...
def predict(username):
    ...
    #sentiment_clean_df = pd.read_csv('./data/pickle_cleaned-data.csv')
    sentiment_clean_df = open('./pickle/pickle_pickle_cleaned-data.pkl.pkl', 'rb')

    user_reco_file = open('./pickle/pickle_pickle_user_final_rating.pkl.pkl', 'rb')
    user_reco_table = pickle.load(user_reco_file)

    sentiment_model_file = open('./pickle/pickle_pickle_sentiment-classification-xg-boost-model.pkl.pkl', 'rb')
    sentiment_model = pickle.load(sentiment_model_file)

    tfidf_file = open('./pickle/pickle_tfidf-vectorizer.pkl', 'rb')
